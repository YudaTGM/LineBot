    ...
    try:
        ...
        if op.type == 13:
            ...
            if mid in op.param3:
                ...
                Inviter = op.param3.replace("ud7fdef235e281104d5fe70c68e6d1891",',')
                I,nviterX = Inviter.split("u1d86967da5fb13fad2bc422a51b963ce")
                matched_list = []
               ...
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv1 ourl","y link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
		...
		link_re = re.compile('(?:line\:\/|line\.me\/R)\/ti\/g\/g2\/([a-zA-Z0-9_-]+)?')
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    kk.sendText(msg.to,"Group mau di bersihkan.")
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to, "00%s/detik" % (elapsed_time))
